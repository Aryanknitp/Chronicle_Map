...
import { Upload as UploadIcon, MapPin, Image, FileText, Mic, Video, X, Check } from 'lucide-react';
...
const UploadPage = () => {
  ...
  const handleSubmit = async () => {
    toast.success('Upload submitted successfully! Our team will review it shortly.');
    resetDraft();
    navigate('/');
  };
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-stone-600">
              Share your photos, documents, and stories to help preserve local history
            </p>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                {step === 1 && 'Select photos, documents, audio, or video files to upload'}
                {step === 2 && 'Provide information about your contribution'}
                {step === 3 && 'Pin your content to a specific location on the map'}
            ...
            <CardContent>
                ...
                <div className="space-y-6">
                  ...
                  {selectedFiles.length > 0 && (
                    <div className="space-y-2">
                      <h3 className="font-semibold text-stone-900">Selected Files:</h3>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-stone-600 mt-2">
                          By checking this box, you confirm that you own this content or have
                          permission from the copyright holder to share it publicly on
                          ChronicleMap. You agree that this content will be made available
                          under a Creative Commons license for preservation and educational
                          purposes.
                        </p>
                      </div>
                    </div>
              ...
              {step === 5 && (
                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-stone-900 mb-2">Files to Upload</h3>
                    <p className="text-stone-600">{selectedFiles.length} file(s) selected</p>
                  </div>
                  ...
                  <div>
                    ...
                    <dl className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <dd className="font-medium text-stone-900">{formData.year}</dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-stone-500">Category:</dt>
                        <dd className="font-medium text-stone-900">{formData.category}</dd>
                      </div>
                      <div className="flex justify-between">
                        <dt className="text-stone-500">Location:</dt>
                        <dd className="font-medium text-stone-900">{formData.location}</dd>
                      </div>
                    </dl>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-900">
                      <strong>What happens next?</strong> Your submission will be reviewed by
                      our team of historians and preservationists. Once approved, it will be
                      published on ChronicleMap and become part of the community archive.
                    </p>
                  </div>
                </div>
              )}
